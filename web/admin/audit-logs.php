...
function badge_class(string $type): string {
  // map to your theme colors (uses bootstrap-ish classes; tweak to your CSS if needed)
  return match ($type) {
...
function safe_json_pretty(?string $json): string {
  if (!$json) return '';
...
<div class="container-fluid py-4" style="max-width: 1400px;">
  <div class="d-flex align-items-center justify-content-between mb-3">
    <div>
      ...
      <div style="color: var(--lr-text-muted);">Security + activity trail (latest <?= (int)$limit ?>)</div>
    </div>
    ...
    <div class="row g-2 align-items-end">
      ...
      <div class="col-md-3">
        ...
        <select class="form-control" name="limit">
          <?php foreach ([200, 300, 500, 1000] as $n): ?>

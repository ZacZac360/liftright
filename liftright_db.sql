...
--
-- Host: localhost:3306
-- Generation Time: Apr 17, 2026 at 01:55 PM
...
CREATE TABLE `rep_metrics` (
  ...
  `fatigue_level` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fatigue_trend` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `training_logs` (
  ...
  `fatigue_summary` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, 'LiftRight Trainer', 'trainer@liftright.local', '$2y$10$lFD.vTC26SMwnPRhRyWsnuf.zQwDEiGkIJcNTrZN4EQb2y.VJoUJe', 'trainer', 26, NULL, NULL, 'wasdasdadsas', 'uploads/profile_photos/user_2.png', '312das', 3, '[\"sdasdasdsada\"]', 1, '2025-12-16 15:18:20', '2026-04-17 10:26:59', NULL, 'approved', 0, 0, NULL, NULL, '2026-02-24 16:40:02', 'default'),
(3, 'Test Trainee User1', 'user@liftright.local', '$2y$10$lFD.vTC26SMwnPRhRyWsnuf.zQwDEiGkIJcNTrZN4EQb2y.VJoUJe', 'user', 21, '2003-11-14', 'male', 'Test Traineeeeeeee', 'uploads/profile_photos/user_3.png', NULL, NULL, NULL, 1, '2025-12-16 15:18:20', '2026-04-17 13:48:36', 2, 'approved', 0, 0, NULL, NULL, '2026-02-24 16:40:02', 'default'),
...
(12, 'Febrilo Par', 'diamondthekidrs44@gmail.com', '$2y$10$hQrIxA2Is.JOQFt2h6eFBOsUajtZvxhkLCTzC0J8uAeM4lDjqLtAK', 'user', NULL, '2004-02-17', 'male', 'Hi! I\'m one of the contributors to this thesis, and I\'m also the CEO of Hotdog.', 'uploads/profile_photos/user_12.jpg', NULL, NULL, NULL, 1, '2026-04-09 16:18:31', '2026-04-17 12:54:50', 2, 'approved', 0, 0, NULL, NULL, '2026-04-09 16:18:31', 'dark'),
...
--
ALTER TABLE `auth_audit_logs`
  MODIFY `event_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
...
--
ALTER TABLE `expert_reviews`
  MODIFY `review_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `feedback`
--
ALTER TABLE `feedback`
  MODIFY `feedback_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=462;
...
--
ALTER TABLE `notifications`
  MODIFY `notif_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `rep_metrics`
  MODIFY `rep_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=893;

--
-- AUTO_INCREMENT for table `rep_snapshots`
--
ALTER TABLE `rep_snapshots`
  MODIFY `snapshot_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1115;
...
--
ALTER TABLE `training_logs`
  MODIFY `log_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=235;
